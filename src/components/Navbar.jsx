...
const Navbar = () => {
  ...
  return (
    <div className="navbar">
      ...
      <img src='https://cdn-icons-png.flaticon.com/128/210/210545.png' alt='favorites' />
      </button>
      <button onClick={(e) => signout(e)}>
      <img src="https://cdn-icons-png.flaticon.com/128/4436/4436954.png" className='logout-icon'/> 
      </button>
      </div>
    </div>
  )
